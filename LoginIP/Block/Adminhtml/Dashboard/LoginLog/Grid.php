...
namespace TrainingMonish\LoginIP\Block\Adminhtml\Dashboard\LoginLog;

use Magento\Backend\Block\Template\Context;
use Magento\Backend\Helper\Data as BackendData;
use Magento\Framework\Exception\LocalizedException;
use Magento\Framework\Phrase;
use TrainingMonish\LoginIP\Block\Widget\Grid\Column\Renderer\Status;
use TrainingMonish\LoginIP\Block\Widget\Grid\Column\Renderer\Time;
use TrainingMonish\LoginIP\Helper\Data;
use TrainingMonish\LoginIP\Model\ResourceModel\LoginLog\CollectionFactory;

/**
 * Class Grid
 * @package TrainingMonish\LoginIP\Block\Adminhtml\Dashboard\LoginLog
 */
