...
class Save extends \TrainingMonish\GridForm\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('trainingmonish_gridform/*/edit', ['id' => $model->getId()]);
                    return;
                }
                $this->_redirect('trainingmonish_gridform/*/');
                return;
            } catch (\Magento\Framework\Exception\LocalizedException $e) {
                $this->messageManager->addError($e->getMessage());
                $id = (int)$this->getRequest()->getParam('id');
                if (!empty($id)) {
                    $this->_redirect('trainingmonish_gridform/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('trainingmonish_gridform/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('trainingmonish_gridform/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('trainingmonish_gridform/*/');
